...
export const STRINGS: Record<LangCode, Dict> = {
  tr: {
    ...
    'pron.newWord':      'Başka kelime',
    'pron.recording':    'Kaydediliyor... Durdurmak için tıklayın.',
    'pron.great':        'Harika telaffuz!',
    'pron.tryAgain':     'Biraz daha pratik yapmalısın',
    'pron.youSaid':      'Senin söylediğin',
  ...
  en: {
    ...
    'pron.newWord':      'New word',
    'pron.recording':    'Recording... Tap to stop.',
    'pron.great':        'Great pronunciation!',
    'pron.tryAgain':     'Keep practicing',
    'pron.youSaid':      'You said',
